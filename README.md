...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yellowbrick-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10437&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yellowbrick-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yellowbrick` can be installed with:

```
conda install yellowbrick
```

It is possible to list all of the versions of `yellowbrick` available on your platform with:
